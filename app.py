...
# Read a deployment secret first, then fall back to environment variable.
try:
...
with st.sidebar:
    ...
    api_key = st.text_input(
        ...
        type="password",
        help="For production, store GROQ_API_KEY in Streamlit Secrets.",
    )
...
extra = st.text_area(
    ...
    placeholder=(
        "e.g. Focus on board-exam questions, use simple explanations, "
...
if generate:
    ...
    def update_progress(stage: str, value: int):
    ...
    try:
        ...
        status.success("✅ All 5 AI workflow stages completed!")
        ...
        st.error(
            ...
            "Please check your inputs, API key, and deployment logs."
        )
...
if "workflow_result" in st.session_state:
    ...
    with tab5:
        ...
        st.write("The refinement stage receives the complete workflow context:")
        st.code(
...
st.divider()
st.caption("AI Study Pack Generator • Python + Streamlit + Groq")
